...
################################################
##  Eyelid positions derived from the config  ##
################################################
...
#####################################
## Eyes and eyelids moves (tuples) ##
#####################################

# Eyes and eyelids move at the same time in tuples of 6 values (since we have 6 servos):

# The first 2 servos control the eyes, simultaneously moving both left/right and up/down
# The last 4 servos control the 4 eyelids, individually controlling their openness/closedness
# ((eyes)lr, (eyes)ud, (eyelid)l_upper, (eyelid)l_lower, (eyelid)r_upper, (eyelid)r_lower)
